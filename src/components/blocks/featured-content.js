                            ...
                            featuredContent.content.map((content, i) => {
                                switch (content.contentType[0]) {
                                    case 'image':
                                        ...
                                        return (
                                            <div className="scroll-reveal mb-6 sm:mb-8" ref={scrollRevealRefs[i + 1]}>
                                                <GatsbyImage image={getImage(content.imageBlock.image.node.gatsbyImage)} alt={content.imageBlock.image.node.altText || content.imageBlock.link.title} />
                                            </div>
                                        )
                                    case 'text':
                                        return (
