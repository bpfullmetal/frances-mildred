            ...
            switch (content.contentType[0]) {
              case 'image':
                return (
                  ...
                  >
                    <GatsbyImage
                      image={content?.imageBlock?.image?.node?.localFile?.childImageSharp?.gatsbyImageData ? getImage(content.imageBlock.image.node.localFile.childImageSharp.gatsbyImageData) : null }
                      alt={
